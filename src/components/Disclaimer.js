  ...
  return (
    <div>
      ...
      <Container>
        ...
        <p className="disclaimer-text">
        The data you upload is stored in our database and associated with the username of your choice. Anyone with access to your usename will be able to view your results. Alternatively, you may upload a file anonymously. The file will be stored in our database for the duration of your session but will not be retrievable via username after your session has ended.
        </p>
