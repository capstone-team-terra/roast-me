...
export default function Summary(props) {
  ...
  const totalTime = Math.floor(Object.keys(runtime.data).reduce((acc, key) => acc + runtime.data[key], 0) / 60);
    ...
    <Container className="text-center">
      ...
      <Row className="mb-5">
        <Col xs sm md={3} data-aos="zoom-in-up">
          ...
          <h2 className="mt-3" style={{fontSize: '1em'}}>Year Joined</h2>
        </Col>
        <Col xs sm md={3} data-aos="zoom-in-up">
          <div style={{ width: "80%", margin: "auto" }}>
                  <CircularProgressbar
          ...
          <h2 className="mt-3" style={{fontSize: '1em'}}>Top Show</h2>
        </Col>
        <Col xs sm md={3} data-aos="zoom-in-up">
          <div style={{ width: "80%", margin: "auto" }}>
                  <CircularProgressbar
          ...
          <h2 className="mt-3" style={{fontSize: '1em'}}>Total Time</h2>
        </Col>
        <Col xs sm md={3} data-aos="zoom-in-up">
          <div style={{ width: "80%", margin: "auto" }}>
            <CircularProgressbar
          ...
          <h2 className="mt-3" style={{fontSize: '1em'}}>Favorite Genre</h2>
        </Col>
      </Row>
      <Row className="justify-content-center mt-5" data-aos="zoom-in-up">
        <Col xs sm md={6}>
          ...
          <p className="mt-5">Based on your viewing history, you are {totalScore}% basic!</p>
          </Col>
      </Row>
    </Container>
  );
